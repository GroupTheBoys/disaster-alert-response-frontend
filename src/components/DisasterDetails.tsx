...
const DisasterDetails: React.FC = () => {
  ...
  const disasterDetails = disasterData[disasterId as keyof typeof disasterData];
        ...
        <CardContent className="p-6">
          <div className="flex items-center mb-4">
            <AlertTriangle className={`mr-2 h-8 w-8 ${
              disasterDetails.severity === 'High' ? 'text-red-500' : 
              disasterDetails.severity === 'Medium' ? 'text-yellow-500' : 'text-green-500'
            }`} />
